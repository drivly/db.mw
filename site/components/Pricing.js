    ...
    <div id='pricing' className="bg-gray-900 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-base font-semibold leading-7 text-pink-400">Pricing</h2>
          ...
          >
            ...
            {frequencies.map((option) => (
              <RadioGroup.Option
                ...
                value={option}
                className={({ checked }) =>
                  classNames(checked ? 'bg-pink-500' : '', 'cursor-pointer rounded-full py-1 px-2.5')
                }
              >
          ...
          {tiers.map((tier) => (
            <div
              ...
              className={classNames(
                tier.mostPopular ? 'bg-white/5 ring-2 ring-pink-500' : 'ring-1 ring-white/10',
            ...
            >
              <div className="flex items-center justify-between gap-x-4">
                ...
                {tier.mostPopular ? (
                  <p className="rounded-full bg-pink-500 py-1 px-2.5 text-xs font-semibold leading-5 text-white">
                    Most popular
                  </p>
                ) : null}
              </div>
