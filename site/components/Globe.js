...
import { markers, preferredColos } from '../../data/colos'
...
export default function Globe() {
  ...
  useEffect(() => {
    ...
    const globe = createGlobe(canvasRef.current, {
      ...
      // markers: markers(['IAD', 'LHR', 'JFK', 'CDG', 'AMS', 'FRA', 'HKG', 'ATL', 'ORD', 'DFW', 'DEN', 
      ...
      // ]),
      // markers: preferredColos.map(({lat, lon}) => ({location: [lat, lon], size: 0.1})),
      ...
      markers: [
        ...
        // Bangalore
        { location: [12.9715987, 77.5945627], size: 0.1 },
        // Cape Town
        ...
        // Honalulu
        { location: [21.3069444, -157.8583333], size: 0.1 },
        // Hong Kong
        ...
        // Melbourne
        { location: [-37.8142176, 144.9631608], size: 0.1 },
        // Mexico City
        ...
        // Munich
        { location: [48.1351253, 11.5819806], size: 0.1 },
        // New Delhi
        { location: [28.6139391, 77.2090212], size: 0.1 },
        // New York
        ...
        // Sao Paulo
        { location: [-23.5506507, -46.6333824], size: 0.1 },
        // Seoul
        { location: [37.566535, 126.9779692], size: 0.1 },
        // Santiago
        { location: [-33.4488897, -70.6692655], size: 0.1 },
        // Seattle
